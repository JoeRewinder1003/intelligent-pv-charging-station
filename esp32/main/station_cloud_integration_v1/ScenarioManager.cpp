...
bool ScenarioManager::setScenarioByName(
    const char* scenarioNameValue
) {
  if (scenarioNameValue == nullptr ||
      scenarioNameValue[0] == '\0') {
    return false;
  }
  ...
  if (strcmp(scenarioNameValue, "CLEAR_DAY") == 0) {
    setScenario(ScenarioType::CLEAR_DAY);
      ...
      strcmp(scenarioNameValue, "CLOUDY_DAY") == 0
  ) {
    setScenario(ScenarioType::CLOUDY_DAY);
  } else if (
      strcmp(scenarioNameValue, "LOW_BATTERY") == 0
  ) {
    setScenario(ScenarioType::LOW_BATTERY);
  } else if (
      strcmp(scenarioNameValue, "HIGH_DEMAND") == 0
  ) {
    setScenario(ScenarioType::HIGH_DEMAND);
  } else if (
      strcmp(scenarioNameValue, "FAULT_EVENT") == 0
  ) {
    setScenario(ScenarioType::FAULT_EVENT);
  } else if (
      strcmp(scenarioNameValue, "TRACKING_FAULT") == 0
  ) {
    setScenario(ScenarioType::TRACKING_FAULT);
  } else if (
      strcmp(scenarioNameValue, "STALE_DATA") == 0
  ) {
...
void ScenarioManager::loadProfile(ScenarioType scenario) {
  ...
  switch (scenario) {
    case ScenarioType::CLOUDY_DAY:
      ...
      profile_.availablePanelCount = 3;
      profile_.pvAvailabilityFactor = 1.0f;
      ...
      // Independent simulated Solar MEMS inputs.
      profile_.sunSensorRadiationWm2 = 220.0f;
      profile_.sunReferenceAngleDeg = 28.0f;
    ...
    case ScenarioType::LOW_BATTERY:
      ...
      // Independent simulated Solar MEMS inputs.
      profile_.sunSensorRadiationWm2 = 180.0f;
      profile_.sunReferenceAngleDeg = 30.0f;
    ...
    case ScenarioType::HIGH_DEMAND:
      ...
      // Independent simulated Solar MEMS inputs.
      profile_.sunSensorRadiationWm2 = 620.0f;
      profile_.sunReferenceAngleDeg = 32.0f;
    ...
    case ScenarioType::TRACKING_FAULT:
      ...
      // Independent simulated Solar MEMS inputs.
      profile_.sunSensorRadiationWm2 = 680.0f;
      profile_.sunReferenceAngleDeg = 30.0f;
    ...
    case ScenarioType::STALE_DATA:
      ...
      // Independent simulated Solar MEMS inputs.
      profile_.sunSensorRadiationWm2 = 520.0f;
      profile_.sunReferenceAngleDeg = 30.0f;
    ...
    default:
      ...
      // Independent simulated Solar MEMS inputs.
      profile_.sunSensorRadiationWm2 = 780.0f;
      profile_.sunReferenceAngleDeg = 30.0f;
